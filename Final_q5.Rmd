...
colnames(cc_cards) = c("card_description", "money_game","true/false","move")
...
colnames(chance_cards) = c("Card Description","money_game","true/false", "move")
...
money_board<-function(){
  if(player_df[player+1, 2] == 3 || player_df[player+1, 2] == 18 || player_df[player+1, 2] == 34 ){
    cc_money()
  }
  if(player_df[player+1, 2] == 8 || player_df[player+1, 2] == 23 || player_df[player+1, 2] == 37 ){
    chance_money()
  }
...
cc_money<-function(){
  player_df[player+1,3] = player_df[player+1,3] + cc_cards[,2]
  if(cc_cards[,2] < 0){
...
chance_money<-function(){
  player_df[player+1,3] = player_df[player+1,3] + chance_cards[,2]
  if(chance_cards[,2] < 0){
...
cc_cards = transform(cc_cards, money_game = as.numeric(money_game))
chance_cards = transform(chance_cards, money_game = as.numeric(money_game))
