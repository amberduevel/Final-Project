...
player_turn = function(player) {
  s = move()
  mono_board[s, 9] = as.numeric(mono_board[s, 9] + 1)
  player_df[player+1, 2] = s
  player = (player + 1)%%num_players
  
  #Stuff to test it. Doesn't quite work but it's better
  # print(player)
  # print(s)
  # print(player_df[player+1, 2])
  # print("")
  
  return(assign("player_df", player_df, .GlobalEnv))
  return(assign("mono_board", mono_board, .GlobalEnv))
}
