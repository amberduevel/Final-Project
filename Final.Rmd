...
money_amount <-150
Money<-function(x){
  if(x==property_amount){
    money_amount=money_amount-property_amount
    return(money_amount)
  }else if(x==bank_amount){
    money_amount=money_amount-bank_amount
    return(money_amount)
  }else if(x==player_amount){
    money_amount=money_amount-player_amount
    return(money_amount)
  }else if(x==reward){
    money_amount=money_amount+reward
    return(money_amount)
  }
}
